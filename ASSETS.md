...
The [Acorn Hopper and Moss Mouse candidates](art/candidates/README.md) are additional original character studies under the same MIT license. Their concepts used AI-generated images; their editable meshes, materials, small rigs, shape keys, finite idle/locomotion/affection animations, and held sleep poses were authored in Blender without third-party 3D assets. The current refinement and original proof are both retained. They are review candidates and are not bundled as selectable pets in the shipping app.
