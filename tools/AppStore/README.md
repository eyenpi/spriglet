...
- [ ] Complete the **current** age-rating questionnaire. The present app has no public user-generated content, advertising, unrestricted embedded web browsing, gambling, contests, mature themes, or medical advice. It does have optional **AI-generated conversation**: Apple's on-device model answers the person's own questions through Siri or Shortcuts, and replies are never shared with anyone else. Answer the form's AI and chat questions for that capability. The companion persona declines health, legal, and money advice and suggests a trusted person or professional instead. Naming one's local pet is not public user-generated content. Answer the actual form; Apple calculates the rating. Do not select Kids Category merely because the artwork is cute. [Set an age rating](https://developer.apple.com/help/app-store-connect/manage-app-information/set-an-app-age-rating).
