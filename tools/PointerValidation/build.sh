...
check_bundle="$check_output/PointerSourceValidation.app"
check_sdk="$(xcrun --sdk macosx --show-sdk-path)"
check_arch="$(uname -m)"

mkdir -p "$check_output" "$check_bundle/Contents/MacOS" "$check_bundle/Contents/Resources"
rm -rf "$check_bundle/Contents/Resources/AcornHopper"
ditto "$check_root/Sources/Spriglet/Resources/AcornHopper" "$check_bundle/Contents/Resources/AcornHopper"
...
xcrun swiftc -swift-version 6 -strict-concurrency=complete -warnings-as-errors -O \
    ...
    "$check_dir/PointerSourceCheck.swift" \
    -o "$check_bundle/Contents/MacOS/PointerSourceCheck"
cat > "$check_bundle/Contents/Info.plist" <<'PLIST'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0"><dict>
<key>CFBundleIdentifier</key><string>dev.spriglet.pointer-validation</string>
<key>CFBundleName</key><string>Pointer Source Validation</string>
<key>CFBundleExecutable</key><string>PointerSourceCheck</string>
