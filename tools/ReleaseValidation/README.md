...
`../../scripts/package-release.sh` is the entry point. See [distribution.md](../../docs/distribution.md) for local-preview and Developer ID usage and the current signing blocker.
