...
check_bundle="$check_output/ContextValidation.app"
...
xcrun swiftc -swift-version 6 -strict-concurrency=complete -warnings-as-errors -O \
    ...
    "$check_dir/ContextCheck.swift" \
    -o "$check_bundle/Contents/MacOS/ContextCheck"
cat > "$check_bundle/Contents/Info.plist" <<'PLIST'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0"><dict>
<key>CFBundleIdentifier</key><string>dev.spriglet.context-validation</string>
<key>CFBundleName</key><string>Context Validation</string>
<key>CFBundleExecutable</key><string>ContextCheck</string>
