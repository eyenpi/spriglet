...
struct CompanionPersonaTests {
    ...
    func coreInstructions() {
        ...
        #expect(text.contains("never claim to see, hear, or sense anything around the person"))
        #expect(text.contains("Never use lists, headings, markdown, or emoji."))
        #expect(text.contains("suggest talking with a trusted person or a professional"))
